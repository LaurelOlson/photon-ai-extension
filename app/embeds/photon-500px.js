  ...
  $('body').on('mouseenter', '.link', function() {
    ...
    $imgLink.find('.flip').one('click', function() {
        ...
        chrome.runtime.onMessage.addListener(function(req, sender, sendResponse) {
            if (req) {
                zeButtonFront.css({'background-image': 'url("chrome-extension://hijnoccjmdgleaafippfiocophahkhkl/images/check-50.png")'});
                zeButtonBack.css({'background-image': 'url("chrome-extension://hijnoccjmdgleaafippfiocophahkhkl/images/check-50.png")'});
            }
        });
